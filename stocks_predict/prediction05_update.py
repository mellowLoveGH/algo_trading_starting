...
for it in stocks_info[:]: #[('ZLAB', '9688.HK', 0.5*7.8)]:#
    ...
    day_num = 120
    trend_df = df_data1[-day_num:].copy()
    draw_trend(trend_df, ref_code, stock_code, [1, 4, 5], ma1, ma2, 20, 2)# 
...
while i<len(stocks_info):
    ...
    st, et = "2022-06-01", "2023-07-31"
    it_df = get_df_data(stock_code1, st, et)
    if ".HK" in stock_code1:
        stocks_HK_df[name1] = it_df['Close']
    else:
        stocks_US_df[name1] = it_df['Close']
    i += 1
...
# %%
pair_stocks = {}
correlation_df = stocks_df.corr().copy()
i = 0
while i < len(correlation_df):
    row_name = correlation_df.index[i]
    row_info = correlation_df.iloc[i]
    for col_name in correlation_df.index:
        cor_score = round(row_info[col_name]*100, 2)
        if cor_score > 85 and row_name != col_name:
            if row_name+"_"+col_name not in pair_stocks and col_name+"_"+row_name not in pair_stocks:
                pair_stocks[row_name+"_"+col_name] = cor_score
    i += 1

for k, v in pair_stocks.items():
    print(k, v, sep="\t")
...
positive_corr = [
    [('BABA', '9988.HK', 1), ('WB', '9898.HK', 1*7.8), ('BILI', '9626.HK', 1 * 7.8), ('ZH', '2390.HK', 3 * 7.8), ('Xiaomi', '1810.HK', 1*7.8)],
    [('BIDU', '9888.HK', 1), ('NTES', '9999.HK', 0.2 * 7.8), ('WB', '9898.HK', 1*7.8)],
    [('JD', '9618.HK', 0.5 * 7.8), ('MPNGY', '3690.HK', 0.5 * 7.8), ('Kuaishou', '1024.HK', 1*7.8)],
    [('MPNGY', '3690.HK', 0.5 * 7.8), ('Kuaishou', '1024.HK', 1*7.8)],
    [('LI', '2015.HK', 0.5 * 7.8), ('XPEV', '9868.HK', 0.5*7.8)],
    [('XPEV', '9868.HK', 0.5*7.8), ('NIO', '9866.HK', 1 * 7.8)],
    [('BILI', '9626.HK', 1 * 7.8), ('Kuaishou', '1024.HK', 1*7.8)],
    [('TCOM', '9961.HK', 1 * 7.8), ('YUMC', '9987.HK', 1*7.8), ('EDU', '9901.HK', 0.1*7.8), ('MNSO', '9896.HK', 0.5*7.8)],
    [('YUMC', '9987.HK', 1*7.8), ('EDU', '9901.HK', 0.1*7.8), ('HTHT', '1179.HK', 0.1*7.8),	('TME', '1698.HK', 0.5*7.8),	('MNSO', '9896.HK', 0.5*7.8)],
    [('EDU', '9901.HK', 0.1*7.8), ('MNSO', '9896.HK', 0.5*7.8)],
    [('ZH', '2390.HK', 3 * 7.8), ('WB', '9898.HK', 1*7.8)],
    [('WB', '9898.HK', 1*7.8), ('TENCENT', '0700.HK', 1*7.8)],
    [('TENCENT', '0700.HK', 1*7.8), ('ZTO', '2057.HK', 1*7.8)],
    [('TME', '1698.HK', 1*7.8), ('SenseTime', '0020.HK', 1*7.8), ('TCOM', '9961.HK', 1 * 7.8), ('TENCENT', '0700.HK', 1*7.8) ],
    [('Xiaomi', '1810.HK', 1*7.8), ('BABA', '9988.HK', 1), ('BILI', '9626.HK', 1 * 7.8), ('WB', '9898.HK', 1*7.8), ('TENCENT', '0700.HK', 1*7.8)],
    [('CMB', '3968.HK', 1*7.8), ('BABA', '9988.HK', 1), ('BILI', '9626.HK', 1 * 7.8), ('WB', '9898.HK', 1*7.8) ]
]

negative_corr = [
    [('NIO', '9866.HK', 1 * 7.8), ('EDU', '9901.HK', 0.1*7.8), ('MNSO', '9896.HK', 0.5*7.8), ('TCOM', '9961.HK', 1 * 7.8), ('YUMC', '9987.HK', 1*7.8)]
]
...
stocks_info = [ ('BIDU', '9888.HK', 1), ('NTES', '9999.HK', 0.2 * 7.8) ] # ('TCOM', '9961.HK', 1 * 7.8), ('PDD', 'PDD', 1*7.8)
st, et = "2022-12-01", "2023-07-31"
...
tmp_df = get_df_data('1698.HK', st, et)
