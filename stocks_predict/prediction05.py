...
def draw_trend(trend_df, ref_code, stock_code, show_list=[1, 4, 5], ma1=6, ma2=27):
...
for it in stocks_info[:]: #[('ZLAB', '9688.HK', 0.5*7.8)]:#
    ...
    day_num = 120
    trend_df = df_data1[-day_num:].copy()
    draw_trend(trend_df, ref_code, stock_code, [1, 4, 5], ma1, ma2)# 
...
positive_corr = [
    ...
    [('MNSO', '9896.HK', 0.5*7.8), ('SenseTime', '0020.HK', 1*7.8)],
...
stocks_info = [ ('Xiaomi', '1810.HK', 1*7.8), ('TENCENT', '0700.HK', 1*7.8) ] # ('TCOM', '9961.HK', 1 * 7.8), ('PDD', 'PDD', 1*7.8)
st, et = "2022-08-01", "2023-07-31"
